PS C:\Users\justu\source\repos\Visio-Diagram-Generator> cd C:\Users\justu\source\repos\Visio-Diagram-Generator
>> 
>> # 1. Build everything (picks up the new planner/runner code)
>> dotnet build Visio-Diagram-Generator.sln -c Release
>> 
>> # 2. Regenerate the callgraph IR/diagram
>> $fixtureRoot = "out\fixtures\invSys\callgraph"
>> New-Item -ItemType Directory -Force -Path $fixtureRoot | Out-Null
>> 
>> dotnet run --project src\VDG.VBA.CLI -- vba2json `
>>     --in samples\invSys `
>>     --out $fixtureRoot\invSys.callgraph.ir.json `
>>     --infer-metrics
>> 
>> dotnet run --project src\VDG.VBA.CLI -- ir2diagram `
>>     --in $fixtureRoot\invSys.callgraph.ir.json `
>>     --out $fixtureRoot\invSys.callgraph.diagram.json `
>>     --mode callgraph `
>>     --semantics-generated-at 2024-01-01T00:00:00Z
>> 
>> # 3. Slice down to the AddGoodsReceived fixture with the new flag
>> $outSliceDir = "out\fixtures\invSys\add-goods-received"
>> $workingSlice = Join-Path $outSliceDir "minimal_invSys_AddGoodsReceived.diagram.json"
>> $goldenSlice = "fixtures\minimal_invSys_AddGoodsReceived.diagram.json"
>> 
>> py -3 tools\slice_diagram_fixture.py `
>>     --source $fixtureRoot\invSys.callgraph.diagram.json `
>>     --target-id modInvMan.AddGoodsReceived_Click `
>>     --output $workingSlice `
>>     --final $goldenSlice `
>>     --slice-name invSys.AddGoodsReceived_Click `
>>     --skip-lane-containers
>>
>> # 4. Render the slice via the CLI (writes .vsdx + new diagnostics)
>> $cli = "src\VDG.CLI\bin\Release\net48\VDG.CLI.exe"
>> $outVsdx = Join-Path $outSliceDir "minimal_invSys_AddGoodsReceived.vsdx"
>> $diagJson = Join-Path $outSliceDir "minimal_invSys_AddGoodsReceived.diagnostics.json"
>>
>> & $cli --diag-json $diagJson $goldenSlice $outVsdx
>>
...
5f-jvrv
  ...
  G.Core.Contracts.dll
  VDG.Core.Contracts -> C:\Users\justu\source\repos\Visio-Diagram-Generator\src\VDG.Core.Contracts\bin\Release\net8.0\VDG.Core.C
  ontracts.dll
  VDG.VBA.CLI.Tests -> C:\Users\justu\source\repos\Visio-Diagram-Generator\tests\VDG.VBA.CLI.Tests\bin\Release\net8.0\VDG.VBA.CL
  I.Tests.dll
C:\Program Files\dotnet\sdk\8.0.416\Microsoft.Common.CurrentVersion.targets(1890,5): warning NU1702: ProjectReference 'C:\Users\
...
\justu\source\repos\Visio-Diagram-Generator\tests\VDG.Core.Tests\VDG.Core.Tests.csproj]
  ...
  VDG.Core -> C:\Users\justu\source\repos\Visio-Diagram-Generator\src\VDG.Core\bin\Release\net8.0\VDG.Core.dll
C:\Users\justu\source\repos\Visio-Diagram-Generator\src\VisioDiagramGenerator.Algorithms\ViewModePlanner.fs(537,20): error FS003
9: The value or constructor 'viewModeSprawl' is not defined. Maybe you want one of the following:   ViewModule [C:\Users\justu\  
source\repos\Visio-Diagram-Generator\src\VisioDiagramGenerator.Algorithms\VisioDiagramGenerator.Algorithms.fsproj]
C:\Users\justu\source\repos\Visio-Diagram-Generator\src\VisioDiagramGenerator.Algorithms\ViewModePlanner.fs(548,44): error FS003
9: The value or constructor 'viewModeSprawl' is not defined. Maybe you want one of the following:   ViewModule [C:\Users\justu\  
source\repos\Visio-Diagram-Generator\src\VisioDiagramGenerator.Algorithms\VisioDiagramGenerator.Algorithms.fsproj]
C:\Users\justu\source\repos\Visio-Diagram-Generator\src\VisioDiagramGenerator.Algorithms\ViewModePlanner.fs(554,44): error FS003 
9: The value or constructor 'viewModeSprawl' is not defined. Maybe you want one of the following:   ViewModule [C:\Users\justu\  
source\repos\Visio-Diagram-Generator\src\VisioDiagramGenerator.Algorithms\VisioDiagramGenerator.Algorithms.fsproj]
C:\Users\justu\source\repos\Visio-Diagram-Generator\src\VisioDiagramGenerator.Algorithms\ViewModePlanner.fs(558,44): error FS003 
9: The value or constructor 'viewModeSprawl' is not defined. Maybe you want one of the following:   ViewModule [C:\Users\justu\  
source\repos\Visio-Diagram-Generator\src\VisioDiagramGenerator.Algorithms\VisioDiagramGenerator.Algorithms.fsproj]
C:\Users\justu\source\repos\Visio-Diagram-Generator\src\VisioDiagramGenerator.Algorithms\ViewModePlanner.fs(589,44): error FS003
9: The value or constructor 'viewModeSprawl' is not defined. Maybe you want one of the following:   ViewModule [C:\Users\justu\  
source\repos\Visio-Diagram-Generator\src\VisioDiagramGenerator.Algorithms\VisioDiagramGenerator.Algorithms.fsproj]
C:\Users\justu\source\repos\Visio-Diagram-Generator\src\VisioDiagramGenerator.Algorithms\ViewModePlanner.fs(593,44): error FS003 
9: The value or constructor 'viewModeSprawl' is not defined. Maybe you want one of the following:   ViewModule [C:\Users\justu\  
source\repos\Visio-Diagram-Generator\src\VisioDiagramGenerator.Algorithms\VisioDiagramGenerator.Algorithms.fsproj]
C:\Users\justu\source\repos\Visio-Diagram-Generator\src\VisioDiagramGenerator.Algorithms\ViewModePlanner.fs(620,20): error FS003 
9: The value or constructor 'viewModeSprawl' is not defined. Maybe you want one of the following:   ViewModule [C:\Users\justu\  
source\repos\Visio-Diagram-Generator\src\VisioDiagramGenerator.Algorithms\VisioDiagramGenerator.Algorithms.fsproj]
C:\Users\justu\source\repos\Visio-Diagram-Generator\src\VisioDiagramGenerator.Algorithms\ViewModePlanner.fs(635,44): error FS003 
9: The value or constructor 'viewModeSprawl' is not defined. Maybe you want one of the following:   ViewModule [C:\Users\justu\  
source\repos\Visio-Diagram-Generator\src\VisioDiagramGenerator.Algorithms\VisioDiagramGenerator.Algorithms.fsproj]
C:\Users\justu\source\repos\Visio-Diagram-Generator\src\VisioDiagramGenerator.Algorithms\ViewModePlanner.fs(641,44): error FS003
9: The value or constructor 'viewModeSprawl' is not defined. Maybe you want one of the following:   ViewModule [C:\Users\justu\  
source\repos\Visio-Diagram-Generator\src\VisioDiagramGenerator.Algorithms\VisioDiagramGenerator.Algorithms.fsproj]
C:\Users\justu\source\repos\Visio-Diagram-Generator\src\VisioDiagramGenerator.Algorithms\ViewModePlanner.fs(2219,43): error FS00
72: Lookup on object of indeterminate type based on information prior to this program point. A type annotation may be needed pri 
or to this program point to constrain the type of the object. This may allow the lookup to be resolved. [C:\Users\justu\source\r 
epos\Visio-Diagram-Generator\src\VisioDiagramGenerator.Algorithms\VisioDiagramGenerator.Algorithms.fsproj]
C:\Users\justu\source\repos\Visio-Diagram-Generator\src\VisioDiagramGenerator.Algorithms\ViewModePlanner.fs(2439,36): error FS00
01: The type 'EdgeRoute' does not have 'null' as a proper value [C:\Users\justu\source\repos\Visio-Diagram-Generator\src\VisioDi 
agramGenerator.Algorithms\VisioDiagramGenerator.Algorithms.fsproj]
...
review: summary written to C:\Users\justu\source\repos\Visio-Diagram-Generator\out\fixtures\invSys\callgraph\invSys.callgraph.review.txt
...
info: connector count: 37
info: pagination analysis - usable height 7.50in, predicted pages 1.
info: lane 'Modules' nodes per page => 1:9
warning: lane overcrowded: lane='Modules' page=1 occupancy=114% nodes=9 usable=7.50in
error: page overflow: page=1 occupancy=114% (usable 7.50in); top: [modInvLogs.LogMultipleInventoryChanges(0.42in), modInvMan.AddGoodsReceived_Click(0.42in), modInvMan.DisplayMessage(0.42in)]
info: bundles planned: 1 groups; max bundle size: 8
info: estimated straight-line crossings: 0
info: corridor staggering applied where available (lane bundles with >1 edges: 8).
info: planned route crossings: 24; avg path length: 1.19in
info: containers: 3
...
warning: bundle separation 0.25in may be ineffective for 45 end(s) due to small node height; consider reducing layout.routing.bundleSeparationIn or increasing node heights.
info: diagnostics JSON written: C:\Users\justu\source\repos\Visio-Diagram-Generator\out\fixtures\invSys\add-goods-received\minimal_invSys_AddGoodsReceived.diagnostics.json
info: layout outputMode=view
info: layout canvas 12.75in x 8.10in
info: layout nodes=9 modules=3 containers=3
info: planner summary modules=0 segments=0 delta=+0 splitModules=0 avgSegments/module=0.00 pages=1 avgModules/page=3.0 avgConnectors/page=16.0 maxOccupancy=0.0% maxConnectors=16 layers=1 overflowPages=1 overflowContainers=3 crowdedLanes=1 partialRender=yes  
warning: render completed with mitigations; review docs/ErrorHandling.md for fallback guidance.
error: page 1 connectors=16 limit=400 modules=3 laneWarnings=1 pageOverflow=yes partial=yes
info: layer 1 modules=3 shapes=12 connectors=8
warning: sub-container 'modInvLogs' overflows lane 'Modules'.
warning: sub-container 'modInvMan' overflows lane 'Modules'.
warning: sub-container 'modUR_Transaction' overflows lane 'Modules'.
info: created 1 page(s) (9 nodes, 8 connectors, avg 8.0 connectors/page)
warning: skipped 29 connector(s); see diagnostics for pagination details
info: planner suggested 1 page(s); rendered 1 page(s)
info: page plan 1: nodes=9, connectors=16, occupancy≈0.0%, modules=modInvLogs, modInvMan, modUR_Transaction
info: rendered page 1: nodes=9, connectors=8, skippedConnectors=29
Saved diagram: C:\Users\justu\source\repos\Visio-Diagram-Generator\out\fixtures\invSys\add-goods-received\minimal_invSys_AddGoodsReceived.vsdx